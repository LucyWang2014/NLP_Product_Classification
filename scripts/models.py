...
takes in X_train, y_train, X_val, y_val, X_test, y_test
returns classifier and/or prediction results
'''
...
def main(data, model='mlp', num_epochs=500):
    '''
    run model with options:
    args:
        data: X_train, y_train, X_val, y_val, X_test, y_test.  Numpy arrays
    '''
...
if __name__ == '__main__':
    if ('--help' in sys.argv) or ('-h' in sys.argv):
        print("Trains a neural network on image and/or text data using Lasagne.")
